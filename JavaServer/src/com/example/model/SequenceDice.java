...
public class SequenceDice implements Serializable {
    ...
    private Map<Player, List<Integer>> playerSequences;
    private Map<Integer, List<Integer>> teamSequences;
    private Map<Player, List<Integer>> longestPlayerSequences;
    private Map<Integer, List<Integer>> longestTeamSequences;
    ...
    public String getLongestSequences() {
        ...
        if (players.size() == 2 || players.size() == 3) {
            for (Player player : players) {
                ...
                result.append("com.example.model.Player: ").append(player.getName())
